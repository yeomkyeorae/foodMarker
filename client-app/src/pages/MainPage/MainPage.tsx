...
import {
  Restaurant,
  RestaurantDetail,
} from '../../components/interfaces/Restaurant';
...
function MainPage({history}: Props): React.ReactElement {
  ...
  useEffect(() => {
    ...
    const optionLocation =
      myPlace === String(LocationCode.All) ? '' : locationName;
            ...
            <S.List key={ix}>
              ...
              <div>
                <div>
                  ...
                  <p style={{fontWeight: '300', margin: '0'}}>{el.address}</p>
                  <p style={{fontWeight: '400', margin: '0'}}>{el.username}</p>
                </div>
              </div>
            </S.List>
          ))}
