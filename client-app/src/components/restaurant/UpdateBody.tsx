...
import { updateRestaurant, registerJpegImg, registerHeicImg } from '../../_actions/restaurant_action';
...
const UpdateBody = ({
  ...
  const [preImages, setPreImages] = useState(restaurantImgUrls ? restaurantImgUrls : []);
    ...
    <>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      margin: '5px',
                      cursor: 'pointer',
                      border: `${representImageIx === index ? '5px solid red' : '0px'}`,
                    }}
      ...
      >
        {isConverting ? (
          ...
          <Button variant='warning' onClick={changeRestaurant} style={{ color: 'white' }}>
            수정하기
          </Button>
        )}
      </Modal.Footer>
